;(function () {
  ...
  angular
    ...
    .component('accountCard', {
      ...
      controller: ['$scope', '$mdDialog', '$mdBottomSheet', 'gettextCatalog', 'accountService', 'storageService', 'SATOSHI_UNIT', 'toastService', AccountCardController]
    })

  function AccountCardController ($scope, $mdDialog, $mdBottomSheet, gettextCatalog, accountService, storageService, SATOSHI_UNIT, toastService) {
  ...
  //    add('Open in explorer', 'open_in_new')
    ...
    this.submitTransaction = (selectedAccount, formData) => {
      return accountService.createTransaction(0, {
        ...
        amount: parseInt((formData.amount * SATOSHI_UNIT).toFixed(0)),
        smartevents: formData.smartevents,
    ...
    this.showSendTransaction = selectedAccount => {
      ...
      function totalBalance (minusFee) {
        ...
        return accountService.numberToFixed((minusFee ? balance - fee : balance) / SATOSHI_UNIT)
      }
